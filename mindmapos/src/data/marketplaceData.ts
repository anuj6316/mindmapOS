...
export const marketplaceProducts: Product[] = [
  ...
  },
  {
    ...
    icon: '🎯',
    name: 'Lead Qualifier',
    tagline: 'Score, enrich and route inbound leads automatically.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 28400,
    ...
    reviewsCount: 640,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Sales', 'CRM', 'Lead Routing', 'Automation'],
    description: 'Lead Qualifier automates inbound lead triage end-to-end. It enriches contacts, scores fit, routes to the right owner, and creates clean CRM records for faster first response.',
    whatItCanDo: [
      '"Score every inbound lead by ICP match"',
      '"Enrich company and contact details before assignment"',
      '"Route enterprise leads to senior reps automatically"',
      '"Send first-touch email drafts to SDR owners"'
    ]
  },
  {
    id: 'agent-010',
    ...
    icon: '📈',
    name: 'Deal Pulse',
    tagline: 'Monitor deals, flag stalls, and draft follow-ups.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 19200,
    ...
    reviewsCount: 520,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Sales', 'Pipeline', 'Forecasting', 'Follow-up'],
    description: 'Deal Pulse continuously scans pipeline health and identifies at-risk opportunities. It drafts targeted next steps so reps can recover momentum quickly.',
    whatItCanDo: [
      '"Flag all deals stale for more than 5 days"',
      '"Draft context-aware follow-up emails from latest activity"',
      '"Create weekly pipeline risk summaries for managers"',
      '"Highlight forecast slippage by segment"'
    ]
  },
  {
    id: 'agent-011',
    ...
    icon: '🤝',
    name: 'Onboarder AI',
    tagline: 'Automate onboarding from accepted offer to day 90.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 12800,
    ...
    reviewsCount: 390,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['HR', 'Onboarding', 'IT Provisioning', 'People Ops'],
    description: 'Onboarder AI coordinates HR, IT, and managers to deliver a reliable onboarding journey. It handles paperwork, provisioning, schedules, and milestone reminders.',
    whatItCanDo: [
      '"Launch onboarding checklist when offer is accepted"',
      '"Trigger contract and NDA signing workflows"',
      '"Provision baseline access across core tools"',
  ...
  },
  {
    ...
    icon: '🔭',
    name: 'Talent Scout',
    tagline: 'Screen applicants, schedule interviews, and support offers.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 9300,
    ...
    reviewsCount: 310,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Recruiting', 'ATS', 'Hiring', 'HR Automation'],
    description: 'Talent Scout accelerates top-of-funnel recruiting by scoring candidates, coordinating interview logistics, and preparing recruiter-ready summaries.',
    whatItCanDo: [
      '"Score incoming resumes against job requirements"',
      '"Send interview slots and reminders automatically"',
      '"Create hiring-manager summaries for shortlisted candidates"',
      '"Prepare offer packet handoff notes"'
    ]
  },
  {
    id: 'agent-013',
    ...
    icon: '🧾',
    name: 'Invoice Ops',
    tagline: 'Capture, validate, approve, and pay invoices automatically.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 41200,
    ...
    reviewsCount: 1020,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Finance', 'AP', 'Invoice', 'Approvals'],
    description: 'Invoice Ops streamlines accounts payable with OCR extraction, policy checks, and approval routing to reduce processing cost and cycle time.',
    whatItCanDo: [
      '"Extract invoice details from email attachments"',
      '"Validate invoice data against PO records"',
      '"Route high-value invoices for manager approval"',
      '"Queue payment and archive signed documents"'
    ]
  },
  {
    id: 'agent-014',
    ...
    icon: '🛡️',
    name: 'Expense Guard',
    tagline: 'Detect policy violations and auto-approve compliant expenses.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 22600,
    ...
    reviewsCount: 480,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Finance', 'Expenses', 'Policy', 'Compliance'],
    description: 'Expense Guard reviews claims in real time, approves low-risk submissions automatically, and escalates outliers with clear policy explanations.',
    whatItCanDo: [
      '"Auto-approve compliant expense reports"',
      '"Flag duplicates and policy mismatches"',
      '"Escalate risky reimbursements with reason codes"',
      '"Generate weekly spend snapshots by team"'
    ]
  },
  {
    id: 'agent-015',
    ...
    tagline: 'Detect, triage, escalate, and resolve incidents with audit trails.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 8100,
    ...
    reviewsCount: 250,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Operations', 'Incident Response', 'Reliability', 'On-call'],
    description: 'Incident Commander coordinates alerts, diagnostics, and response workflows so teams can reduce detection and resolution times during outages.',
    whatItCanDo: [
      '"Correlate alerts and open an incident channel"',
      '"Attach runbook recommendations from context"',
      '"Create incident tickets with timeline details"',
      '"Draft post-incident summary after resolution"'
    ]
  },
  {
    id: 'agent-016',
    ...
    tagline: 'Automate vendor research, RFP drafting, and PO creation.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 6400,
    ...
    reviewsCount: 220,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Operations', 'Procurement', 'Vendors', 'Sourcing'],
    description: 'Procurement Bot shortens sourcing cycles by automating vendor comparison, RFP generation, response scoring, and purchase handoffs.',
    whatItCanDo: [
      '"Generate RFP docs from internal purchase requests"',
      '"Compare vendor quotes in a standardized scorecard"',
      '"Track approvals and signature status"',
      '"Create PO handoff package for finance"'
    ]
  },
  {
    id: 'agent-017',
    ...
    icon: '✨',
    name: 'Content Engine',
    tagline: 'Repurpose one asset into multi-channel campaign content.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 33700,
    ...
    reviewsCount: 760,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Marketing', 'Content', 'Social', 'Campaigns'],
    description: 'Content Engine converts source content into channel-specific assets for social, email, and web teams while maintaining brand and messaging consistency.',
    whatItCanDo: [
      '"Turn blog posts into social thread packs"',
      '"Draft newsletter copy from campaign briefs"',
      '"Generate variant hooks for A/B testing"',
      '"Schedule content tasks to team workspaces"'
    ]
  },
  {
    id: 'agent-018',
    ...
    tagline: 'Track rankings, detect opportunities, and optimize pages.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 14200,
    ...
    reviewsCount: 340,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Marketing', 'SEO', 'Analytics', 'Growth'],
    description: 'SEO Growth Agent monitors search performance trends, identifies drops and opportunities, and proposes optimization actions for content teams.',
    whatItCanDo: [
      '"Highlight pages that lost ranking positions"',
      '"Suggest content updates for high-intent keywords"',
      '"Build weekly SEO opportunity reports"',
      '"Track technical issues impacting visibility"'
    ]
  },
  {
    id: 'agent-019',
    category: 'Agents',
    badge: 'BUSINESS · ENGINEERING',
    icon: '🔍',
    name: 'PR Guardian',
    tagline: 'Review pull requests for defects, risks, and style issues.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 52100,
    ...
    description: 'PR Guardian adds an automated review pass before human review, surfacing potential bugs, risk patterns, and missing test coverage early.',
    whatItCanDo: [
      '"Review diff for potential regressions"',
      '"Flag insecure patterns and risky dependency changes"',
      '"Suggest test cases for uncovered paths"',
      '"Post summary comments to pull requests"'
    ]
  },
  {
    id: 'agent-020',
    ...
    icon: '🎧',
    name: 'Support Triage',
    tagline: 'Classify, prioritize, and auto-resolve tier-1 tickets.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 67400,
    ...
    reviewsCount: 1490,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Support', 'CX', 'Ticketing', 'SLA'],
    description: 'Support Triage routes inbound tickets intelligently, resolves repetitive issues using knowledge sources, and escalates high-risk cases quickly.',
    whatItCanDo: [
      '"Classify new tickets by category and severity"',
      '"Auto-reply with verified KB answers for tier-1"',
      '"Escalate product bugs to engineering systems"',
      '"Track SLA risk and urgent queue spikes"'
    ]
  },
  {
    id: 'agent-021',
    ...
    icon: '⚖️',
    name: 'Contract Intel',
    tagline: 'Extract clauses, highlight risk, and compare standards.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 4200,
    ...
    description: 'Contract Intel accelerates legal review by extracting key terms, checking policy deviations, and summarizing exposure in plain language.',
    whatItCanDo: [
      '"Extract obligations and renewal dates from contracts"',
      '"Flag non-standard clauses against legal playbooks"',
      '"Create risk summaries for counsel review"',
      '"Route approved contracts for signature steps"'
    ]
  },
  {
    id: 'agent-022',
    category: 'Agents',
    badge: 'BUSINESS · EXECUTIVE',
    icon: '📊',
    name: 'Exec Briefing',
    tagline: 'Generate a daily CEO/CFO brief from core business systems.',
    creator: 'MindMapOS',
    version: 'v1.0.0',
    price: 'FREE',
    installs: 3800,
    ...
    reviewsCount: 140,
    platforms: ['Linux', 'Windows', 'macOS'],
    tags: ['Executive', 'Reporting', 'KPIs', 'Leadership'],
    description: 'Exec Briefing aggregates revenue, product, hiring, and finance metrics into one concise narrative for leadership decision-making.',
    whatItCanDo: [
      '"Summarize daily KPI movement across departments"',
      '"Highlight anomalies and potential business risks"',
      '"Create board-ready status snapshots"',
      '"Publish leadership brief at scheduled times"'
    ]
  },
